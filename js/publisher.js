///URL to millicast API
 ...
 // let streamName = params.get('id');// can be taken from URL
  ...
  let player1 = "https://rnkvogel.github.io/Millicast-Pub-SS/player/?accountId=" + accountId + "&streamName=" + streamName ;   
  let player2 = "https://rnkvogel.github.io/Millicast-Pub-SS/player/screenshare.html?accountId=" + accountId + "&streamName=" + streamName + "SS";
  
function startScreen() {
  //screenshare
   let tokenVal=document.getElementById("tokenTxt").value;
   let accountVal = document.getElementById("viewTxt").value;
   let stream1 = "https://rnkvogel.github.io/Millicast-Pub-SS/screen/?id=" + streamName +"&at=" + accountVal +"&tn="+ tokenVal + "&cod=" +videoCodec + "&bit=" + videoBitrateSS;
   window.open(stream1 );
